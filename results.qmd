...
![Initial GSEA Plot](figures/fig01_GSEA1.png){fig-cap="GSEA results showing metabolic pathway enrichment."}
...
The most prominent finding was the strong transcriptional disruption in T cells, which also increased in proportion in ALD. This combination of increased abundance and loss of cytotoxic effector programs is consistent with published reports of T cell exhaustion and dysfunction in chronic liver disease [@li2019; @albillos2014]. In healthy liver, T cells and NK cells together provide cytotoxic immune surveillance. The parallel suppression of NK cell cytotoxic pathways observed here, alongside decreased NK cell abundance.This suggests that both arms of cytotoxic immunity are simultaneously weakened in ALD. This finding aligns with work showing that NK cell activity is impaired in patients with alcoholic liver disease [@ju2015].
